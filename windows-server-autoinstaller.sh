...
case $choice in
    ...
    7)
        # Windows 10 Ghost
        img_file="windows10ghost.img"
        iso_link="https://dl.dropboxusercontent.com//scl/fi/kkqup4tmw9jyhbx6am1bs/WIN10.PRO.AIO.U27.X64.-WPE.ISO?rlkey=p636otxms93n2iify6bp7ie2e&st=uqeq5sc7&dl=0"
        iso_file="windows10ghost.iso"
        ;;
    *)
